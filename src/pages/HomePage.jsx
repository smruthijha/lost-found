...
export function HomePage() {
  ...
  // ✅ Run once on mount — loadItems/loadStats are stable useCallback refs
  useEffect(() => {
    loadStats();
    loadItems(); // fetch all, filter client-side
  }, []); // eslint-disable-line react-hooks/exhaustive-deps

  // All filtering done client-side — no extra Firestore calls on filter change
