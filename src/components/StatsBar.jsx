export function StatsBar({ stats }) {
  const tiles = [
    ...
    { label:"Claim Approved", val:stats.claim_approved||0, color:"#16a34a", bg:"#dcfce7", border:"#86efac",
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg> },
    { label:"Fully Resolved", val:stats.resolved, color:"#7c3aed", bg:"#f5f3ff", border:"#c4b5fd",
